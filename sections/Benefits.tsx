...
export default function Benefits({
  backgroundImage =
    "https://via.placeholder.com/1440x800/22C55E/FFFFFF?text=Background+Image",
  ...
  benefits = [
    {
      ...
      description:
        "Elimine tarefas manuais, do enriquecimento de leads à atualização do CRM.",
      size: "large",
    },
    {
      iconUrl: "https://via.placeholder.com/50x50/16A34A/FFFFFF?text=📊",
      ...
      description:
        "Turn browsing into buying with AI content that addresses customer needs based on real-time market insights.",
      size: "medium",
    },
    {
      iconUrl: "https://via.placeholder.com/50x50/16A34A/FFFFFF?text=🔧",
      ...
      description:
        "Install in under 15 minutes with our seamless integration for all major e-commerce platforms—zero technical headaches.",
      size: "medium",
    },
    {
      iconUrl: "https://via.placeholder.com/50x50/16A34A/FFFFFF?text=🎯",
      ...
      description:
        "Our AI continuously refines your content based on performance data. Most clients see results within the first week.",
      size: "medium",
    },
  ],
}: Props) {
  return (
    <section
      ...
      style={{
        backgroundImage:
          `linear-gradient(rgba(34, 197, 94, 0.7), rgba(34, 197, 94, 0.7)), url(${backgroundImage})`,
