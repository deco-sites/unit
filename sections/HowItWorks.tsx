  ...
  steps = [
    {
      ...
      description:
        'Defina o objetivo: "Encontrar CFOs em fintechs de alto crescimento".\n\nO Seals.ai ativa automaticamente os agentes certos para iniciar a operação.',
      image:
        "https://via.placeholder.com/295x220/22C55E/FFFFFF?text=Chat+Interface",
    ...
    },
    {
      ...
      description:
        "Cada agent executa sua parte com precisão — encontrar leads, enriquecer dados, escrever mensagens, marcar demos.\n\nVocê decide quando e como ativar cada um.",
      image:
        "https://via.placeholder.com/295x220/16A34A/FFFFFF?text=Agent+Network",
    ...
    },
    {
      ...
      description:
        "Monitore o avanço da missão em tempo real. Analise os resultados, refine a estratégia e escale sua operação.",
      image:
        "https://via.placeholder.com/295x220/15803D/FFFFFF?text=Dashboard+Analytics",
